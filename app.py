...
with col1:
    dic_file = st.file_uploader("Suba o arquivo de dicionário (CSV)", type=['csv'])

with col2:
    fato_files = st.file_uploader("Suba as tabelas Registro (fato) (Pode selecionar várias)", type=['csv'], accept_multiple_files=True)
